...
const translations = {
    ...
    ar: {
        ...
        role4: "مصمم UI/UX",
        heroDescription: "ضابط عسكري   بخبرة 11 عامًا، الآن مطور متحمس لبناء تطبيقات الويب الحديثة وتطبيقات الجوال والأنظمة الآمنة. مقيم في البحرين.",
        ...
        storyText2: "ضابط   برتبة نقيب، أجلب قيادة قوية وانضباطًا وعملًا جماعيًا. ماهر في Linux و PowerShell وإدارة قواعد البيانات.",
        languages: "اللغات",
        arabic: "العربية",
        english: "الإنجليزية",
        native: "لغة أم",
