...
export default function AboutSection() {
    ...
    return (
        <section id="about" className="relative py-16 sm:py-20 overflow-hidden">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-64 sm:w-96 h-64 sm:h-96 bg-gradient-to-r from-[#B32626]/10 to-transparent blur-3xl pointer-events-none" />
            ...
            <div className="container mx-auto px-6 sm:px-8 lg:px-12 relative z-10" ref={ref}>
                ...
                <motion.div initial={{ opacity: 0 }} animate={isInView ? { opacity: 1 } : {}} transition={{ duration: 0.4 }} className="text-center mb-10">
                    <span className="theme-accent-label inline-block px-4 py-2 rounded-full bg-[#B32626]/10 text-xs font-medium mb-3">{t("aboutMe")}</span>
                    <h2 className="text-3xl sm:text-4xl font-bold mb-3">
                        <span className="section-heading-text">{t("myJourney")}</span>
                    </h2>
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={isInView ? { opacity: 1 } : {}} transition={{ duration: 0.4, delay: 0.1 }} className="space-y-6">
                        ...
                        <div className="relative p-5 sm:p-6 rounded-2xl bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl">
                            <div className={`flex flex-col sm:flex-row gap-6 sm:gap-8 items-center ${isRTL ? "sm:flex-row-reverse" : ""}`}>
                                <div className="relative shrink-0">
                                    ...
                                    <div className="w-32 h-[220px] lg:w-44 lg:h-[300px] rounded-xl overflow-hidden border-2 border-[#B32626]/30 shadow-xl shadow-[#B32626]/10">
                                        <Image src="/assets/My-pics/1.png" alt="Mohamed Alromaihi" fill className="object-cover" />
                                    </div>
                                    <div className="absolute -bottom-3 -right-3 w-10 h-10 rounded-full bg-gradient-to-br from-[#B32626] to-[#771111] flex items-center justify-center border-4 border-[var(--background)] shadow-lg">
                                ...
                                <div className={`flex-1 text-center ${isRTL ? "sm:text-right" : "sm:text-left"} self-center`}>
                                    ...
                                    <div className={`inline-block px-3 py-1 rounded-full bg-[#B32626]/10 border border-[#B32626]/20 text-[#B32626] font-medium text-sm mb-4`}>
                                    ...
                                    <div className={`flex items-center gap-2 justify-center ${isRTL ? "sm:justify-start" : "sm:justify-start"}`}>
                                        <MapPin className="w-5 h-5 text-[#B32626]" />
                        ...
                        <div className="p-5 sm:p-6 rounded-2xl bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl">
                            <h3 className={`text-lg sm:text-xl font-semibold text-[var(--foreground)] mb-4 flex items-center gap-2 ${isRTL ? "flex-row-reverse" : ""}`}>
                                <span className="w-8 h-8 rounded-lg bg-[#B32626]/20 flex items-center justify-center">
                                    <BookOpen className="w-4 h-4 text-[#B32626]" />
                                </span>
                                {t("myStory")}
                            </h3>
                        ...
                        <div className="p-5 sm:p-6 rounded-2xl bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl">
                            <h3 className={`text-lg sm:text-xl font-semibold text-[var(--foreground)] mb-4 flex items-center gap-2 ${isRTL ? "flex-row-reverse" : ""}`}>
                                <span className="w-8 h-8 rounded-lg bg-[#B32626]/20 flex items-center justify-center">
                                    <Globe className="w-4 h-4 text-[#B32626]" />
                                </span>
                                {t("languages")}
                            </h3>
                            <div className="flex gap-4">
                                <div className="flex-1 p-3 sm:p-4 rounded-xl bg-[var(--background-card)] border border-[var(--border-color)] text-center">
                                    <span className="w-10 h-10 mx-auto mb-2 rounded-lg bg-gradient-to-br from-[#B32626] to-[#771111] flex items-center justify-center text-white font-bold text-sm">AR</span>
                                ...
                                <div className="flex-1 p-3 sm:p-4 rounded-xl bg-[var(--background-card)] border border-[var(--border-color)] text-center">
                                    <span className="w-10 h-10 mx-auto mb-2 rounded-lg bg-gradient-to-br from-[#771111] via-[#922020] to-[#B93232] flex items-center justify-center text-white font-bold text-sm">EN</span>
                    ...
                    <motion.div initial={{ opacity: 0 }} animate={isInView ? { opacity: 1 } : {}} transition={{ duration: 0.4, delay: 0.2 }} className="space-y-6">
                        ...
                        <div className="p-5 sm:p-6 rounded-2xl bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl">
                            <h3 className={`text-lg sm:text-xl font-semibold text-[var(--foreground)] mb-6 flex items-center gap-2 ${isRTL ? "flex-row-reverse" : ""}`}>
                                <span className="w-8 h-8 rounded-lg bg-[#B32626]/20 flex items-center justify-center">
                                    <Briefcase className="w-4 h-4 text-[#B32626]" />
                                </span>
                                {t("workExperience")}
                            </h3>
                            <div className="space-y-6">
                                {experiences.map((exp, index) => (
                                    <div key={index} className={`relative ${isRTL ? "pr-6 border-r-2" : "pl-6 border-l-2"} border-[#B32626]/30`}>
                                        <div className={`absolute ${isRTL ? "-right-[9px]" : "-left-[9px]"} top-0 w-4 h-4 rounded-full bg-[#B32626] border-4 border-[var(--background)]`} />
                                        <span className="text-[#B32626] text-xs font-medium">{exp.year}</span>
                        ...
                        <div className="p-5 sm:p-6 rounded-2xl bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl">
                            <h3 className={`text-lg sm:text-xl font-semibold text-[var(--foreground)] mb-6 flex items-center gap-2 ${isRTL ? "flex-row-reverse" : ""}`}>
                                <span className="w-8 h-8 rounded-lg bg-[#771111]/20 flex items-center justify-center">
                                    <GraduationCap className="w-4 h-4 text-[#771111]" />
                                </span>
                                {t("education")}
                            </h3>
                            <div className="space-y-4">
                                {education.map((edu, index) => (
                                    <div key={index} className={`relative ${isRTL ? "pr-6 border-r-2" : "pl-6 border-l-2"} border-[#771111]/30`}>
                                        <div className={`absolute ${isRTL ? "-right-[9px]" : "-left-[9px]"} top-0 w-4 h-4 rounded-full bg-[#771111] border-4 border-[var(--background)]`} />
                                        <span className="text-[#771111] text-xs font-medium">{edu.year}</span>
