...
export default function Footer() {
    ...
    return (
        <footer className="relative py-8 sm:py-12 border-t border-[var(--border-color)]">
            <div className="absolute inset-0 bg-gradient-to-t from-[#B32626]/5 to-transparent" />
            ...
            <div className="container mx-auto px-6 sm:px-8 relative">
                <div className={`flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 ${isRTL ? "md:flex-row-reverse" : ""}`}>
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} className={`flex items-center gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
                        ...
                        <span className="footer-brand-name text-base font-bold">
                    ...
                    <div className={`flex gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
                        <a href="https://github.com/MSR7799" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-[var(--background-glass)] border border-[var(--border-color)] flex items-center justify-center text-[var(--foreground-muted)] hover:text-[var(--foreground)] hover:border-[#B32626]/50 transition-all">
                        ...
                        <a href="mailto:MMALROMAIHI99@GMAIL.COM" className="w-8 h-8 rounded-lg bg-[var(--background-glass)] border border-[var(--border-color)] flex items-center justify-center text-[var(--foreground-muted)] hover:text-[var(--foreground)] hover:border-[#B32626]/50 transition-all">
