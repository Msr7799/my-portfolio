...
export default function Footer() {
    ...
    return (
        <footer className="relative py-8 sm:py-12 border-t border-[var(--border-color)]">
            <div className="absolute inset-0 bg-gradient-to-t from-[#90AB8B]/5 to-transparent" />
            ...
            <div className="container mx-auto px-6 sm:px-8 relative">
                <div className={`flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-6 ${isRTL ? "md:flex-row-reverse" : ""}`}>
                    ...
                    <motion.div whileHover={{ scale: 1.05 }} className={`flex items-center gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
                        ...
                        <span className="text-base font-bold bg-gradient-to-r from-[#90AB8B] to-[#5A7863] bg-clip-text text-transparent">
                    ...
                    <div className={`flex gap-3 ${isRTL ? "flex-row-reverse" : ""}`}>
                        <a href="https://github.com/MSR7799" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-[var(--background-glass)] border border-[var(--border-color)] flex items-center justify-center text-[var(--foreground-muted)] hover:text-[var(--foreground)] hover:border-[#90AB8B]/50 transition-all">
                        ...
                        <a href="mailto:MMALROMAIHI99@GMAIL.COM" className="w-8 h-8 rounded-lg bg-[var(--background-glass)] border border-[var(--border-color)] flex items-center justify-center text-[var(--foreground-muted)] hover:text-[var(--foreground)] hover:border-[#90AB8B]/50 transition-all">
                            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                        </a>
                        <a href="https://wa.me/97337925259?text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%20%D9%85%D8%AD%D9%85%D8%AF%20%3A%20" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-lg bg-[var(--background-glass)] border border-[var(--border-color)] flex items-center justify-center text-[var(--foreground-muted)] hover:text-[#25D366] hover:border-[#25D366]/50 transition-all">
