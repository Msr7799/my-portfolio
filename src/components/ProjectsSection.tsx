                                    ...
                                    <div className="p-5 sm:p-6 flex flex-col flex-grow">
                                        ...
                                        {project.liveUrl && (
                                            <a
                                                ...
                                                className={`flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white text-sm font-semibold hover:shadow-lg hover:shadow-[#667eea]/30 transition-all ${isRTL ? "flex-row-reverse" : ""}`}
                                            >
