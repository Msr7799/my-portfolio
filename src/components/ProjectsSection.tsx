        ...
        <section id="projects" className="relative py-24 sm:py-32 overflow-hidden">
            ...
            <div className="container mx-auto px-6 sm:px-8 lg:px-12" ref={ref}>
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }} className="text-center mb-16">
                    ...
                    <p className="text-[var(--foreground-muted)] max-w-2xl mx-auto text-base sm:text-lg">{t("projectsDesc")}</p>
                </motion.div>
                        ...
                        {filteredProjects.map((project, index) => (
                            ...
                            >
                                <div className="relative rounded-2xl overflow-hidden bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl transition-all duration-500 hover:border-[#667eea]/50 hover:shadow-2xl hover:shadow-[#667eea]/10 h-full flex flex-col">
                                    {/* Featured Badge */}
                                    {project.featured && (
                                        <div className={`absolute top-4 ${isRTL ? "left-4" : "right-4"} z-10 px-3 py-1 rounded-full bg-gradient-to-r from-[#667eea] to-[#764ba2] text-white text-xs font-medium shadow-lg`}>
                                            ⭐ {t("featured")}
                                        </div>
                                    )}
                                    ...
                                    <div className="relative h-52 sm:h-60 overflow-hidden">
                                        ...
                                        <div className="absolute inset-0 bg-gradient-to-t from-[#667eea]/90 to-[#764ba2]/60 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center">
                                            <motion.div initial={{ scale: 0, rotate: -180 }} whileHover={{ scale: 1.1 }} animate={{ scale: 1, rotate: 0 }} className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-sm flex items-center justify-center border border-white/30">
                ...
                {/* View More */}
                <motion.div initial={{ opacity: 0, y: 20 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6, delay: 0.5 }} className="text-center mt-16">
                    <a
                        href="https://github.com/code4alromaihi"
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`inline-flex items-center gap-2 px-8 py-3.5 rounded-full border-2 border-[var(--border-color)] text-[var(--foreground)] font-medium hover:border-[#667eea] hover:bg-[#667eea]/10 transition-all ${isRTL ? "flex-row-reverse" : ""}`}
                    >
                        {t("viewMoreGithub")}
