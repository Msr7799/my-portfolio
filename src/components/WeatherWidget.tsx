    ...
    return (
        <div className="relative">
            ...
            <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 rounded-full bg-[var(--background-glass)] border border-[var(--border-color)] backdrop-blur-xl hover:border-[#667eea]/50 transition-all cursor-pointer ${isRTL ? "flex-row-reverse" : ""}`}
